...
/**
 * GridItemDecoration
 * 设置表格布局时，最好分割线的颜色同recyclerView的样色相同，这样的效果比较好看，
...
public class GridSpaceItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridSpaceItemDecoration setItemDecorationWidth(int itemDecorationWidth) {
        paint.setStrokeWidth(itemDecorationWidth);
        return this;
    }

    public GridSpaceItemDecoration setItemDecorationColor(int itemDecorationColor) {
